...
Source: Amazon Alexa AI / MASSIVE contributors, [AmazonScience/massive](https://huggingface.co/datasets/AmazonScience/massive), version 1.1; CC-BY-4.0. Jax AI selected English/Russian rows, converted intent labels into runtime Choice/Noul questions, and retained original source grouping across splits. These are modified data, not an endorsement by the original authors. The corpus also includes 20 independently authored synthetic MIT rule tasks. Per-row source metadata is in references.jsonl.
